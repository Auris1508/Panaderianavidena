...
function cargarGaleria() {
  const panes = [
    ...
    { nombre: 'turrones', descripcion: 'Como en España, los turrones son un imprescindible en las sobremesas italianas. Los hay de diversos tipos, tanto blandos, como el famoso turrón de Cremona, como duros. Los italianos lo consumen en bandejas con dátiles rellenos e higos, ¡irresistible combinación!', precio: 50, img:'https://www.pexels.com/es-es/foto/azucar-tuercas-frutos-secos-postre-6332062/' },
    { nombre: 'Panettone', descripcion: 'El panettone es un dulce típico de la Navidad en Italia. Se trata de un bizcocho alto y esponjoso, elaborado con harina, huevos, mantequilla, azúcar y frutas confitadas. Su sabor suave y su textura ligera lo convierten en un postre delicioso para disfrutar durante las festividades navideñas.', precio: 80, img:'https://www.pexels.com/es-es/foto/dulce-pan-de-azucar-3184194/' },
     { nombre: 'Macarrón', descripcion: 'Una delicada y dulce galleta francesa tipo sándwich hecha con almendras molidas, claras de huevo y azúcar, rellena de ganache, crema de mantequilla o mermelada.', precio: 80, img:'https://images.pexels.com/photos/586830/pexels-photo-586830.jpeg' },
  ];
