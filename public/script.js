    ...
    .then(productos => {
      ...
      productos.forEach((prod, idx) => {
        ...
        tbody.innerHTML += `
          <tr>
            <td>${idx + 1}</td>
            <td><img src="${imgSrc}" alt="pan" class="img-thumbnail" style="width:95px;height:95px;object-fit:cover; "></td>
...
function cargarGaleria() {
  const panes = [
    ...
    { nombre: 'Sopa de mariscos', descripcion: 'La sopa de mariscos es una preparación culinaria en forma de sopa que presenta como ingrediente uno o varios tipos de mariscos. Este tipo de sopas es muy popular en las cocinas de aquellos países que tienen costa marítima.', precio: 300, img:'https://images.pexels.com/photos/2532439/pexels-photo-2532439.jpeg' },
    { nombre: 'Ceviche', descripcion: 'El ceviche es un plato tradicional de la gastronomía latinoamericana, especialmente popular en países como Perú, México y Ecuador. Consiste en marinar pescado o mariscos frescos en jugo de limón o lima, junto con otros ingredientes como cebolla, cilantro, ají y sal.', precio: 250, img:'https://images.pexels.com/photos/16931502/pexels-photo-16931502.jpeg' },
    { nombre: 'Paella de mariscos', descripcion: 'La paella de mariscos es una variante popular de la tradicional paella española que se caracteriza por incluir una variedad de mariscos frescos como ingredientes principales. Este plato es conocido por su sabor delicioso y su presentación colorida.', precio: 400, img:'https://www.pexels.com/es-es/foto/30488931/' },
    { nombre: 'Langosta a la parrilla', descripcion: 'La langosta a la parrilla es un plato exquisito que resalta el sabor natural y la textura tierna de este marisco. La langosta se corta por la mitad, se sazona con hierbas y especias, y se cocina a la parrilla hasta que esté perfectamente asada.', precio: 600, img:'https://www.pexels.com/es-es/foto/comida-plato-restaurante-barca-6510301/' },
    { nombre: 'Flan', descripcion: 'La tarta de queso es uno de los postres más populares y queridos en todo el mundo. Su textura cremosa y su sabor suave la convierten en una opción irresistible para los amantes del dulce.', precio: 50, img:'https://images.pexels.com/photos/302468/pexels-photo-302468.jpeg' },
    { nombre: 'turrones', descripcion: 'Como en España, los turrones son un imprescindible en las sobremesas italianas. Los hay de diversos tipos, tanto blandos, como el famoso turrón de Cremona, como duros. Los italianos lo consumen en bandejas con dátiles rellenos e higos, ¡irresistible combinación!', precio: 50, img:'https://www.pexels.com/es-es/foto/mesa-decoracion-celebracion-fotografia-de-comida-19063539/' },
    { nombre: 'Panettone', descripcion: 'El panettone es un dulce típico de la Navidad en Italia. Se trata de un bizcocho alto y esponjoso, elaborado con harina, huevos, mantequilla, azúcar y frutas confitadas. Su sabor suave y su textura ligera lo convierten en un postre delicioso para disfrutar durante las festividades navideñas.', precio: 80, img:'https://www.pexels.com/es-es/foto/plato-con-bizcocho-de-chocolate-19287497/' },
     { nombre: 'Macarrón', descripcion: 'Una delicada y dulce galleta francesa tipo sándwich hecha con almendras molidas, claras de huevo y azúcar, rellena de ganache, crema de mantequilla o mermelada.', precio: 80, img:'https://www.pexels.com/es-es/foto/fotografia-de-enfoque-selectivo-de-macarrones-3734027/' },
  ];
